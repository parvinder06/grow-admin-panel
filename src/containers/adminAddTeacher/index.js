                        ...
                        <div>
                            ...
                            <div>
                                ...
                                }
                                {
                                    profilePictureStatus === 2 && (
                                        <div className={styles.profile}>
                                            <img src={profilePictureLink} className={styles.profileContainer} />
                                            <TextWithCancelButton
                                                text={profilePictureWebLink}
